...
Процедура ЗаполнитьОтчетВнешнимиДаннымиНаСервере(мДанных)
	...
	Пока ИтераторСтрок < мДанных.Количество() Цикл		
		
		// Первая строка есть всегда!
		Если ИтераторСтрок < мДанных.Количество() - 1 Тогда
			ВставитьДополнительнуюСтроку();
		КонецЕсли;
		...
		Пока ИтераторКолонок < мДанных[ИтераторСтрок].Количество() Цикл
			...
			ИмяТекущейКолонки = Формат(ИтераторКолонок, "ЧЦ=" + ИмяЧислоЗнаков + "; ЧВН=; ЧГ=0; ЧФ=" + ПрефиксУровня + "Ч_")
			+ (ИтераторСтрок + 1)
			+ УровеньСтроки;
			
			ТДОбласти[ИмяТекущейКолонки].Значение = мДанных[ИтераторСтрок][ Строка(ИтераторКолонок) ];
...
Функция ОписаниеДанныхОтчета()
	...
	//ВнешниеДанные.Вставить("1");
	//ВнешниеДанные.Вставить("2");
	//ВнешниеДанные.Вставить("3");
...
Процедура ЗаполнитьВнешнимиДанными(Команда)
	...
	//ВнешниеДанные["1"] = "Test";
	//ВнешниеДанные["2"] = "Test";
	//ВнешниеДанные["3"] = "Test";
	...
	ЗаполнитьОтчетВнешнимиДаннымиНаСервере(мДанных);
